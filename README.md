...
* Current size of assets: `~43,70 GB`
* Current amount of files: `480.921 files` 
* Current amount of folders: `10.193 folders` 
...
* KitenokGene for `20.90` assets! ([#3](https://github.com/tailsjs/brawl-stars-assets/issues/1))
