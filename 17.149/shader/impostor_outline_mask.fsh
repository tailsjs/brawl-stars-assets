...
void main (void)
{
	...
	if(specularSample.a == 1.0)
	{
		gl_FragColor = vec4(diffuseColor.rgb * u_colorMul.a, diffuseColor.a);
	}
	else
	{
		float a = texture2D(specularTex, uv + u_outlineScale * vec2(0.923880, 0.382683)).a;
		a += texture2D(specularTex, uv + u_outlineScale * vec2(0.382683, 0.923880)).a;
		a += texture2D(specularTex, uv + u_outlineScale * vec2(-0.382683, 0.923880)).a;
		a += texture2D(specularTex, uv + u_outlineScale * vec2(-0.923880, 0.382683)).a;
		a += texture2D(specularTex, uv + u_outlineScale * vec2(-0.923880, -0.382683)).a;
		a += texture2D(specularTex, uv + u_outlineScale * vec2(-0.382683, -0.923880)).a;
		a += texture2D(specularTex, uv + u_outlineScale * vec2(0.382683, -0.923880)).a;
		a += texture2D(specularTex, uv + u_outlineScale * vec2(0.923880, -0.382683)).a;
